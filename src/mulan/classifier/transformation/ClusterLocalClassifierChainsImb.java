 ...
 */
public class ClusterLocalClassifierChainsImb extends TransformationBasedMultiLabelLearner{
     ...
     * 保存局部分类器链的数组
     */
    protected LocalClassifieChainImb[] lccs;
    /**
     * 保存局部分类器链顺序的数组
     */
    protected int[][] lcIdx;
     ...
     * Default constructor
     */
    public ClusterLocalClassifierChainsImb() {
        this(new J48(), 2, 10, 0.0, true, 1,2.0);
    }
     ...
     */
    public ClusterLocalClassifierChainsImb(Classifier classifier, int aNumOfLocalModels, int iterNum, double maxChange, boolean isDebug, int flag,double rate) {
        super(classifier);
        this.numOfLocalModels = aNumOfLocalModels;
        this.lccs = new LocalClassifieChainImb[aNumOfLocalModels];
    ...
    protected void buildInternal(MultiLabelInstances trainingSet) throws Exception {
        ...
        for (int i = 0; i < this.lcIdx.length; i++) {
            this.lccs[i] = new LocalClassifieChainImb(baseClassifier, this.lcIdx[i], this.sampleRate);
